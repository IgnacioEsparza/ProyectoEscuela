...
public class VerCurso extends javax.swing.JFrame {
    ...
    public void modelo() {
        ...
        JTCurso.setModel(modeloA);
    }

    public void vercursoMetodo(Curso cursoSel, int posicion) {
        ...
        for (int i = 0; i < 30; i++) {
            String[] AlumsCurso = {cursoSel.getEstudiante()[i].getNombre()};
            modeloA.addRow(AlumsCurso);
        }
...
//    public void GuardarAlumno() throws JAXBException, FileNotFoundException {
//
//        Estudiante[] est = new Estudiante[30];
//        for (int i = 0; i < est.length; i++) {
//            //est[i] = new Estudiante((String) JTCurso.getValueAt(i, 1));
//        }
//        //college.getTCursos()[pos].getAsignaturaC()[materia].setActividades(est);
//
//        gx.guardar(college);
...
//    }
    ...
    private void ExportarBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ExportarBotonActionPerformed
        ee.exportar(new File("Alumnos Curso " + curso.getNivel() + " " + curso.getLetra() + ".xls"), JTCurso);
    ...
    private void GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GuardarActionPerformed
        /*try {
            ...
            Logger.getLogger(VerCurso.class.getName()).log(Level.SEVERE, null, ex);
